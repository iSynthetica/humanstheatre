...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		...
		register_sidebar( array(
			'name'          => __( 'Language Menu', 'understrap' ),
			'id'            => 'languages',
			'description'   => 'Widget area for selecting languages in header',
		    'before_widget'  => '<div class="change-languages_widget">',
		    'after_widget'   => '</div><!-- .change-languages_widget -->',
		    'before_title'   => '',
		    'after_title'    => '',
		) );
